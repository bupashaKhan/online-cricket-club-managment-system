            ...
            <div class="row align-content-center">
                <div class="col-lg-7 col-xl-5">
                    ...
                    Dominate</h1>
                        ...
                        <a href="MemberLoginForm.php" class="btn_1">learn more <span class="ti-angle-right"></span> </a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="about_text">
                        ...
                        <a href="MemberLoginForm.php" class="btn_2">read more</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-xl-6">
                    <div class="upcoming_event_1">
                        ...
                        <div class="upcoming_event_text">
                            ...
                            <a href="MemberLoginForm.php" class="btn_2">View Details</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-6  col-xl-6">
